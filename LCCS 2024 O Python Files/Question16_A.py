...
conversion = float(input("Please enter the conversion:"))
if conversion == 1:
    ...
    teaspoons = ml * 0.20
    print("The amount of teaspoons is:", teaspoons)

elif conversion == 5:
    ml = float(input("Please enter number of ml:"))
    tablespoons = ml / 15
    print("The amount of tablespoons is:", tablespoons)

elif conversion == 6:
    ml = float(input("Please enter number of ml:"))
    cups = ml / 236.6
    print("The amount of cups is:", cups)